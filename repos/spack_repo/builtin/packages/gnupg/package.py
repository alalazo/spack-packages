...
class Gnupg(AutotoolsPackage):
    ...
    deprecated("@2.5.17:2.5.20", reason="retired")
    deprecated("@2.5.13:2.5.16", reason="vuln", severity="critical", labels=["CVE-2026-24881"])
    deprecated("@2.5.13:2.5.16", reason="vuln", severity="high", labels=["CVE-2026-24882"])
    deprecated(
        "@:2.2.50,2.3:2.4.8,2.5:2.5.13", reason="vuln", severity="high", labels=["CVE-2025-68973"]
    )
